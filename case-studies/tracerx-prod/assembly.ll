...
@XY = constant i32 797326, align 4
@XZ = constant i32 632362, align 4
@YZ = constant i32 2321827, align 4
...
@.str4 = private unnamed_addr constant [20 x i8] c"/out/tracerx-prod.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = bitcast i32* %x to i8*, !dbg !134
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !dbg !134
  %3 = bitcast i32* %y to i8*, !dbg !135
  call void @klee_make_symbolic(i8* %3, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0)), !dbg !135
  %4 = bitcast i32* %z to i8*, !dbg !136
  call void @klee_make_symbolic(i8* %4, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !dbg !136
  %5 = load i32* %x, align 4, !dbg !137
  %6 = icmp sle i32 1, %5, !dbg !137
  br i1 %6, label %7, label %40, !dbg !137

; <label>:7                                       ; preds = %0
  %8 = load i32* %x, align 4, !dbg !137
  %9 = icmp sle i32 %8, 2000, !dbg !137
  br i1 %9, label %10, label %40, !dbg !137

; <label>:10                                      ; preds = %7
  %11 = load i32* %y, align 4, !dbg !137
  %12 = icmp sle i32 1, %11, !dbg !137
  br i1 %12, label %13, label %40, !dbg !137

; <label>:13                                      ; preds = %10
  %14 = load i32* %y, align 4, !dbg !137
  %15 = icmp sle i32 %14, 2000, !dbg !137
  br i1 %15, label %16, label %40, !dbg !137

; <label>:16                                      ; preds = %13
  %17 = load i32* %z, align 4, !dbg !137
  %18 = icmp sle i32 1, %17, !dbg !137
  br i1 %18, label %19, label %40, !dbg !137

; <label>:19                                      ; preds = %16
  %20 = load i32* %z, align 4, !dbg !137
  %21 = icmp sle i32 %20, 2000, !dbg !137
  br i1 %21, label %22, label %40, !dbg !137

; <label>:22                                      ; preds = %19
  %23 = load i32* %x, align 4, !dbg !139
  %24 = load i32* %y, align 4, !dbg !139
  %25 = mul nsw i32 %23, %24, !dbg !139
  %26 = icmp eq i32 %25, 797326, !dbg !139
  br i1 %26, label %27, label %39, !dbg !139

; <label>:27                                      ; preds = %22
  %28 = load i32* %x, align 4, !dbg !139
  %29 = load i32* %z, align 4, !dbg !139
  %30 = mul nsw i32 %28, %29, !dbg !139
  %31 = icmp eq i32 %30, 632362, !dbg !139
  br i1 %31, label %32, label %39, !dbg !139

; <label>:32                                      ; preds = %27
  %33 = load i32* %y, align 4, !dbg !139
  %34 = load i32* %z, align 4, !dbg !139
  %35 = mul nsw i32 %33, %34, !dbg !139
  %36 = icmp eq i32 %35, 2321827, !dbg !139
  br i1 %36, label %37, label %39, !dbg !139

; <label>:37                                      ; preds = %32
  %38 = call i32 (i8*, i8*, i32, i8*, ...)* bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([2 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8]* @.str4, i32 0, i32 0), i32 20, i8* getel
  br label %39, !dbg !144

; <label>:39                                      ; preds = %37, %32, %27, %22
  br label %40, !dbg !145

; <label>:40                                      ; preds = %39, %19, %16, %13, %10, %7, %0
  ret i32 0, !dbg !146
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str5, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str16, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str27, i64 0, i64 0)) #7, !dbg !149
  unreachable, !dbg !149
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #8, !dbg !151
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str38, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !159
  unreachable, !dbg !159
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #7, !dbg !164
  unreachable, !dbg !164
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #8, !dbg !167
...
!1 = metadata !{metadata !"/out/tracerx-prod.c", metadata !"/opt"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 12, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !2, i32 12} ; [ DW_TAG_subprogram ]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/opt//out/tracerx-prod.c]
...
!12 = metadata !{i32 786484, i32 0, null, metadata !"XY", metadata !"XY", metadata !"", metadata !5, i32 8, metadata !11, i32 0, i32 1, i32* @XY, null} ; [ DW_TAG_variable ] [XY] [line 8] [def]
!13 = metadata !{i32 786484, i32 0, null, metadata !"XZ", metadata !"XZ", metadata !"", metadata !5, i32 9, metadata !11, i32 0, i32 1, i32* @XZ, null} ; [ DW_TAG_variable ] [XZ] [line 9] [def]
!14 = metadata !{i32 786484, i32 0, null, metadata !"YZ", metadata !"YZ", metadata !"", metadata !5, i32 10, metadata !11, i32 0, i32 1, i32* @YZ, null} ; [ DW_TAG_variable ] [YZ] [line 10] [def]
!15 = metadata !{i32 786449, metadata !16, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !17, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/opt/
!16 = metadata !{metadata !"/opt/tracerx/runtime/Intrinsic/klee_div_zero_check.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
...
!19 = metadata !{metadata !"klee_div_zero_check.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
!20 = metadata !{i32 786473, metadata !19}        ; [ DW_TAG_file_type ] [/opt/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
...
!26 = metadata !{i32 786449, metadata !27, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !28, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/opt/
!27 = metadata !{metadata !"/opt/tracerx/runtime/Intrinsic/klee_int.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
...
!30 = metadata !{metadata !"klee_int.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
!31 = metadata !{i32 786473, metadata !30}        ; [ DW_TAG_file_type ] [/opt/tracerx/runtime/Intrinsic/klee_int.c]
...
!40 = metadata !{i32 786449, metadata !41, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !42, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/opt/
!41 = metadata !{metadata !"/opt/tracerx/runtime/Intrinsic/klee_overshift_check.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
...
!44 = metadata !{metadata !"klee_overshift_check.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
!45 = metadata !{i32 786473, metadata !44}        ; [ DW_TAG_file_type ] [/opt/tracerx/runtime/Intrinsic/klee_overshift_check.c]
...
!52 = metadata !{i32 786449, metadata !53, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !54, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/opt/
!53 = metadata !{metadata !"/opt/tracerx/runtime/Intrinsic/klee_range.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
...
!56 = metadata !{metadata !"klee_range.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
!57 = metadata !{i32 786473, metadata !56}        ; [ DW_TAG_file_type ] [/opt/tracerx/runtime/Intrinsic/klee_range.c]
...
!65 = metadata !{i32 786449, metadata !66, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !67, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/opt/
!66 = metadata !{metadata !"/opt/tracerx/runtime/Intrinsic/memcpy.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
...
!69 = metadata !{metadata !"memcpy.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
!70 = metadata !{i32 786473, metadata !69}        ; [ DW_TAG_file_type ] [/opt/tracerx/runtime/Intrinsic/memcpy.c]
...
!85 = metadata !{i32 786449, metadata !86, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !87, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/opt/
!86 = metadata !{metadata !"/opt/tracerx/runtime/Intrinsic/memmove.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
...
!89 = metadata !{metadata !"memmove.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
!90 = metadata !{i32 786473, metadata !89}        ; [ DW_TAG_file_type ] [/opt/tracerx/runtime/Intrinsic/memmove.c]
...
!100 = metadata !{i32 786449, metadata !101, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !102, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/o
!101 = metadata !{metadata !"/opt/tracerx/runtime/Intrinsic/mempcpy.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
...
!104 = metadata !{metadata !"mempcpy.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
!105 = metadata !{i32 786473, metadata !104}      ; [ DW_TAG_file_type ] [/opt/tracerx/runtime/Intrinsic/mempcpy.c]
...
!115 = metadata !{i32 786449, metadata !116, i32 1, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !117, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/o
!116 = metadata !{metadata !"/opt/tracerx/runtime/Intrinsic/memset.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
...
!119 = metadata !{metadata !"memset.c", metadata !"/opt/tracerx/runtime/Intrinsic"}
!120 = metadata !{i32 786473, metadata !119}      ; [ DW_TAG_file_type ] [/opt/tracerx/runtime/Intrinsic/memset.c]
...
!134 = metadata !{i32 13, i32 0, metadata !4, null}
!135 = metadata !{i32 14, i32 0, metadata !4, null}
!136 = metadata !{i32 15, i32 0, metadata !4, null}
!137 = metadata !{i32 17, i32 0, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !4, i32 17, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/opt//out/tracerx-prod.c]
!139 = metadata !{i32 18, i32 0, metadata !140, null}
!140 = metadata !{i32 786443, metadata !1, metadata !141, i32 18, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/opt//out/tracerx-prod.c]
!141 = metadata !{i32 786443, metadata !1, metadata !138, i32 17, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/opt//out/tracerx-prod.c]
!142 = metadata !{i32 20, i32 0, metadata !143, null}
!143 = metadata !{i32 786443, metadata !1, metadata !140, i32 18, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/opt//out/tracerx-prod.c]
!144 = metadata !{i32 21, i32 0, metadata !143, null}
!145 = metadata !{i32 22, i32 0, metadata !141, null}
!146 = metadata !{i32 24, i32 0, metadata !4, null}
!147 = metadata !{i32 13, i32 0, metadata !148, null}
!148 = metadata !{i32 786443, metadata !19, metadata !18, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!149 = metadata !{i32 14, i32 0, metadata !148, null}
!150 = metadata !{i32 15, i32 0, metadata !18, null}
!151 = metadata !{i32 15, i32 0, metadata !29, null}
!152 = metadata !{i32 16, i32 0, metadata !29, null}
...
!158 = metadata !{i32 786443, metadata !44, metadata !43, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!159 = metadata !{i32 27, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !44, metadata !158, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!161 = metadata !{i32 29, i32 0, metadata !43, null}
!162 = metadata !{i32 16, i32 0, metadata !163, null}
!163 = metadata !{i32 786443, metadata !56, metadata !55, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/klee_range.c]
!164 = metadata !{i32 17, i32 0, metadata !163, null}
!165 = metadata !{i32 19, i32 0, metadata !166, null}
!166 = metadata !{i32 786443, metadata !56, metadata !55, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/klee_range.c]
!167 = metadata !{i32 22, i32 0, metadata !168, null}
!168 = metadata !{i32 786443, metadata !56, metadata !166, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/klee_range.c]
!169 = metadata !{i32 25, i32 0, metadata !170, null}
!170 = metadata !{i32 786443, metadata !56, metadata !168, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/klee_range.c]
!171 = metadata !{i32 26, i32 0, metadata !172, null}
!172 = metadata !{i32 786443, metadata !56, metadata !170, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/klee_range.c]
!173 = metadata !{i32 27, i32 0, metadata !172, null}
!174 = metadata !{i32 28, i32 0, metadata !175, null}
!175 = metadata !{i32 786443, metadata !56, metadata !170, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/klee_range.c]
!176 = metadata !{i32 29, i32 0, metadata !175, null}
!177 = metadata !{i32 32, i32 0, metadata !168, null}
!178 = metadata !{i32 34, i32 0, metadata !55, null}
!179 = metadata !{i32 16, i32 0, metadata !68, null}
!180 = metadata !{i32 17, i32 0, metadata !68, null}
...
!186 = metadata !{i32 18, i32 0, metadata !68, null}
!187 = metadata !{i32 16, i32 0, metadata !188, null}
!188 = metadata !{i32 786443, metadata !89, metadata !88, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/memmove.c]
!189 = metadata !{i32 19, i32 0, metadata !190, null}
!190 = metadata !{i32 786443, metadata !89, metadata !88, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/memmove.c]
!191 = metadata !{i32 20, i32 0, metadata !192, null}
!192 = metadata !{i32 786443, metadata !89, metadata !190, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/memmove.c]
...
!196 = metadata !{i32 786443, metadata !89, metadata !190, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/opt/tracerx/runtime/Intrinsic/memmove.c]
...
!201 = metadata !{i32 28, i32 0, metadata !88, null}
!202 = metadata !{i32 15, i32 0, metadata !103, null}
!203 = metadata !{i32 16, i32 0, metadata !103, null}
!204 = metadata !{metadata !204, metadata !182, metadata !183}
!205 = metadata !{metadata !205, metadata !182, metadata !183}
!206 = metadata !{i32 17, i32 0, metadata !103, null}
!207 = metadata !{i32 13, i32 0, metadata !118, null}
!208 = metadata !{i32 14, i32 0, metadata !118, null}
!209 = metadata !{i32 15, i32 0, metadata !118, null}
